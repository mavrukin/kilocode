...
export const dict = {
  ...
  "settings.sandboxing.hint":
    "Збережені зміни мережі, адрес призначення та шляхів для запису застосовуються перед наступним запуском інструмента в кожному сеансі. Увімкнення пісочниці також використовує найновіші налаштування.",
