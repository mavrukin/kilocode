...
export const dict = {
  ...
  "settings.sandboxing.hint":
    "تُطبَّق تغييرات الشبكة والوجهات والمسارات القابلة للكتابة المحفوظة قبل التشغيل التالي للأداة في كل جلسة. ويؤدي تفعيل وضع الحماية أيضًا إلى استخدام أحدث الإعدادات.",
