...
export const dict = {
  ...
  "settings.sandboxing.hint":
    "การเปลี่ยนแปลงเครือข่าย ปลายทาง และเส้นทางที่เขียนได้ที่บันทึกไว้จะมีผลก่อนการเรียกใช้เครื่องมือครั้งถัดไปของแต่ละเซสชัน การเปิดใช้แซนด์บ็อกซ์จะใช้การตั้งค่าล่าสุดด้วย",
